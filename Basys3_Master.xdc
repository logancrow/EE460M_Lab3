...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {sat}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sat}]
set_property PACKAGE_PIN E19 [get_ports {clkout}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {clkout}]
#set_property PACKAGE_PIN U19 [get_ports {an0}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {an0}]
#set_property PACKAGE_PIN V19 [get_ports {an1}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {an1}]
#set_property PACKAGE_PIN W18 [get_ports {an2}]					
